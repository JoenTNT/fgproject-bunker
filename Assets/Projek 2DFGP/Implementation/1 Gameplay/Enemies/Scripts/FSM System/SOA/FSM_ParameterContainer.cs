...
namespace JT.FGP
{
    ...
    public sealed class FSM_ParameterContainer : ScriptableObject, IParameterContainerData,
        IDuplicateSO<FSM_ParameterContainer>
    {
        #region Variables

        [SerializeField]
        private FSM_ParameterData[] _parameterData = new FSM_ParameterData[0];
        ...
        public FSM_ParameterContainer Duplicate()
        {
